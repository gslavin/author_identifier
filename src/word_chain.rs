...
impl WordChain {
    ...
    pub fn new(title: String, text: String, key_length: usize) -> WordChain {
    ...
    pub fn from_path(title: String, path: &str, key_length: usize) -> WordChain {
    ...
    pub fn compare(&self, other: &WordChain) -> Option<f64> {
    ...
    pub fn merge(&self, other: &WordChain) -> Option<WordChain> {
        if self.key_length != other.key_length {
            return None;
        }
